#LDA is supervised — it uses the labels to find directions that best separate the classes.
...
class lda:
    ...
    #PCA function
    def LDA_input(self,x_train,x_test,y_train,n):
    ...
    def LDA_Classification(self,acclog,accsvml,accknn,accdes,accrf):
        import pandas as pd
